...
mkdir -p ./temp/LSUN_256x256_N2M2S128
mkdir -p ./temp/CelebA_128x128_N2M2S64

python COCO-GAN/main.py --config COCO-GAN/configs/LSUN_256x256_N2M2S128.yaml --test --test_output_dir ./temp/LSUN_256x256_N2M2S128
python COCO-GAN/main.py --config COCO-GAN/configs/CelebA_128x128_N2M2S64.yaml --test --test_output_dir ./temp/CelebA_128x128_N2M2S64
