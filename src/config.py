...
MAX_ATTEMPTS_TO_SYNTHESIZE = 30

# Parameters for objects in images
MIN_SCALE = 0.4 # min scale for scale augmentation (maximum extend in each direction, 1=same size as image)
MAX_SCALE = 0.8  # max scale for scale augmentation (maximum extend in each direction, 1=same size as image)
