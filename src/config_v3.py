...
MAX_SCALE = 0.5  # max scale for scale augmentation (maximum extend in each direction, 1=same size as image)
...
MAX_ALLOWED_IOU = 0.3  # IOU > MAX_ALLOWED_IOU is considered an occlusion, need dontocclude=True
